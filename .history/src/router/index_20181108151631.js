...
const SystemLog = resolve => require(['@/components/Admin/AuthorManager/PermissionSet'], resolve);
const SystemLog = resolve => require(['@/components/Admin/AuthorManager/SystemLog'], resolve);
