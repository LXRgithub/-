    ...
    <div class="navmenu-container">
        <div class="navbar" :class="{mgRnull: index === data.length - 1}"
            ...
            <div class="nav-div" @click="item.disable == true? '':navClick(index,item)"
                 ...
                 :class="{actives:(active == index), overact: over == index,
	...
	export default {
		props: {
            ...
            arrowN:{        // 右侧箭头(默认)181102添加
                type: String,
				default: require('../../assets/icon/right.png')
            },
            arrowS:{        // 右侧箭头(选中)181102添加
                type: String,
				default: require('../../assets/icon/arrowS.png')
            },
            arrowNH:{        // 右侧箭头(选中)181102添加
                type: String,
				default: require('../../assets/icon/rightArrow.png')
            }
		},
		data() {
			return {
		...
		methods: {
			...
			navClick(index, item) {
                ...
                console.log('navClick',item.isSubShow)
			},
