    ...
    .navmenu-container {
        ...
        .navbar {
            ...
            .sub-menu { //二级导航
                ...
                .actives2{
                    color: #fff;
                    // background: -webkit-linear-gradient(left, #215BA0 10%, #198bf5 69%, #264169 100%); /* Safari 5.1 - 6.0 */
                    // background: -o-linear-gradient(right, #215BA0 10%, #198bf5 69%, #264169 100%); /* Opera 11.1 - 12.0 */
                    // background: -moz-linear-gradient(right, #215BA0 10%, #198bf5 69%, #264169 100%); /* Firefox 3.6 - 15 */
