...
<template>
  <div class="account-setting">
    ...
    <el-dialog title="修改密码" width="30%" top="30vh"
        ...
        <el-form :model="changePwdForm" ref="numberValidateForm" label-width="100px" class="demo-ruleForm">
        ...
        <span slot="footer" class="dialog-footer">
            <el-button class="admin_button" style="width:100px;font-size:14px;" @click="savePwd('numberValidateForm')">保存</el-button>
        </span>
    </el-dialog>
  </div>
</template>
