...
<template>
  <div class="account-setting">
    ...
    <el-dialog title="修改密码" width="30%" top="30vh"
        ...
        <el-form :model="changePwdForm" ref="changePwdFor   m" label-width="110px" class="demo-ruleForm">
            <el-form-item label="输入原密码" prop="age">
                <el-input type="age" v-model.number="changePwdForm.age" autocomplete="off" style="width:240px;"></el-input>
            </el-form-item>
            <el-form-item label="输入新密码" prop="age">
                <el-input type="age" v-model.number="changePwdForm.age" autocomplete="off" style="width:240px;"></el-input>
            </el-form-item>
            <el-form-item label="再次输入新密码" prop="age">
                <el-input type="age" v-model.number="changePwdForm.age" autocomplete="off" style="width:240px;"></el-input>
            </el-form-item>
        </el-form>
