  ...
  <div class="account-setting">
                ...
                <el-row align="middle" type="flex">
                    ...
                    <el-col :span="12">
                        ...
                        <div>
                            ...
                            <el-button class="admin_button" style="width:120px;" @click="changePwd">修改</el-button>
                        </div>
                    </el-col>
                </el-row>
            </el-main>
    ...
    <el-dialog title="修改密码" width="30%" top="30vh"
        ...
        <span slot="footer" class="dialog-footer">
            ...
            <el-button class="admin_button" style="width:100px;font-size:10px;" @click="changePwd">保存</el-button>
