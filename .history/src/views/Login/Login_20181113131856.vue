            ...
            <el-row type="flex" align="middle">
                <el-main class="content-div">
                    ...
                    <div class="input-div">
                        ...
                        <el-form :model="loginForm" ref="loginForm" :rules="loginRule" label-width="130px" class="signIn">
                            <el-form-item label="" prop="pwd">
                                <el-input placeholder="请输入账号" v-model="loginForm.newPwd">
                                    <i slot="prefix" class="el-icon-account"></i>
                                </el-input>
                            </el-form-item>
                            <el-form-item label="输入新密码" prop="newPwd">
                                <el-input type="age" v-model.number="loginForm.newPwd" autocomplete="off" style="width:240px;"></el-input>
                            </el-form-item>
                            <el-form-item label="再次输入新密码" prop="newPwd2">
                                <el-input type="age" v-model.number="loginForm.newPwd2" autocomplete="off" style="width:240px;"></el-input>
                            </el-form-item>
                        </el-form>
                    </div>
                    <div class="login-button">
                        <el-button class="admin_button" style="width:120px;font-size:16px;" @click="">登录</el-button>
                    </div>
                </el-main>
                 <!-- <el-col :span="24" class="logo-div">
                    <div class="logo"></div>
                    <div class="school">全国高等教育信息服务平台</div>
                 </el-col> -->
                <!-- <el-row>
                    <el-col :span="24" class="logo-div" tag="div">
                        <div class="logo">
                            <img />
                        </div>
                        <div class="school">全国高等教育信息服务平台</div>
