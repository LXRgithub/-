    ...
    <el-container>
        <el-aside :width="asideW34">
            <div class="login-bg">
                ...
                <img src="../../assets/welcome.png" class="float-img">
            </div>
        </el-aside>
        <el-main>
...
export default {
  ...
  data() {
    ...
    //   account: localStorage.getItem("userNum") ? localStorage.getItem("userNum") : "1234", //账号
    //   password: "123456", // localStorage.getItem('UserPassword')? localStorage.getItem('UserPassword')
  ...
  created() {
    ...
    console.log("login", this.$store.state.menuActive);
  }
};
</script>
