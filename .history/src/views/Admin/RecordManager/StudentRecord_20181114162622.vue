                ...
                <el-form class="uip_custom_form" :model="recordForm" ref="changePwdForm" :inline="true">
                    ...
                    <el-form-item label="">
                        <el-autocomplete v-model="state4" :fetch-suggestions="querySearchAsync" :trigger-on-focus="false"
                             suffix-icon="el-icon-search" placeholder="" @select="handleSelect">
                              <i slot="suffix" class="el-input__icon el-icon-date"></i></el-autocomplete>
                    </el-form-item>
                </el-form>
            </el-header>
            <el-main>
...
export default {
  ...
  created() {
      this.getToolData();       // 获取年级数据
       this.restaurants = this.classData;
  }
};
</script>
