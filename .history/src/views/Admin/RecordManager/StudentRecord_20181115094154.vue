       ...
       <el-container>
        ...
        <el-main class="record-main">
            <el-table :data="tableData" style="width: 100%" height="100%"
                ...
                <column120 prop="name" label="姓名00"></column120>
                <column120 prop="name" label="学号00" width="180"></column120>
                <el-table-column prop="name" label="姓名" sortable width="180"> </el-table-column>
                <el-table-column prop="name" label="学号" sortable width="180"> </el-table-column>
