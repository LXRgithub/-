       ...
       <el-container>
        ...
        <el-main class="record-main">
            <el-table :data="tableData" style="width: 100%" height="100%" border
                ...
                <el-table-column prop="id" v-if="showColumn"></el-table-column>
                ...
                <column120 prop="collage" label="性别"></column120>
                <column120 prop="collage" label="联系电话"></column120>
                <el-table-column prop="sex" label="性别" sortable width="180"> </el-table-column>
                <el-table-column prop="tel" label="联系电话" sortable width="180"> </el-table-column>
            </el-table>
        </el-main>
