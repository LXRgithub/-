        ...
        <el-main class="record-main">
            <el-header style="height:auto;">
                <el-form class="uip_custom_form" :model="recordForm" ref="changePwdForm" :inline="true">
                    ...
                    <el-button class="admin_button" style="width:120px;font-size:16px;" @click="clickQuery('recordForm')">查询</el-button>
                </el-form>
            </el-header>
            <el-main>
            </el-main>
...
export default {
  ...
  created() {
      this.getToolData();       // 获取年级数据
       this.restaurants = [ { "value": "三全鲜食（北新泾店）", "address": "长宁区新渔路144号" ,name:'12345'},
