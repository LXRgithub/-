       ...
       <el-container>
        ...
        <el-main class="record-main">
            <el-table :data="tableData" style="width: 100%" height="100%" border
                ...
                <el-table-column prop="no" v-if="showColumn"></el-table-column>
                <column120 prop="indexID" label="序号" width="100"></column120>
                <column120 prop="name" label="姓名"><!--  :isSlots="true" -->
                    <div slot-scope="slot">{{slot.scope.name}}</div>
                </column120>
                <column120 prop="no" label="学号"></column120>
                <column120 prop="grade" label="班级"></column120>
                <column120 prop="collage" label="院系"></column120>
                <column120 prop="sex" label="性别"></column120>
                <column120 prop="tel" label="联系电话"></column120>
            </el-table>
        </el-main>
