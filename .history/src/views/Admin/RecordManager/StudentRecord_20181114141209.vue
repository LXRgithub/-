                ...
                <el-form class="uip_custom_form" :model="recordForm" ref="changePwdForm" :inline="true">
                    <el-form-item label="年级">
                        <el-select v-model="recordForm.grade" placeholder="" style="width:120px;">
                            <el-option v-for="item in gradeData" :label="item.name" :value="data.id" :key="data.id"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="学院">
                        <el-select v-model="recordForm.grade" placeholder="" style="width:120px;">
                            <el-option v-for="data in collageData" :label="data.name" :value="data.id" :key="data.id"></el-option>
                        </el-select>
                    </el-form-item>
