                            ...
                            <div class="user-list">
                               <!--  <el-popover
                                 ...
                                 <!-- <el-popover
                                    ...
                                    <!-- </span> -->
                                <!-- </el-popover> -->
                                    <!-- <div class="add-btn" v-for="(item, index) in customRoleData" :key="index">11
                                        <el-popover
                                            placement="right"
                                            trigger="hover" v-model="popover">
                                                <span>11</span>
                                                <span slot="reference">33</span>
                                        </el-popover>
                                    </div> -->
                                   <!--  <el-popover
                                        placement="right"
                                        trigger="hover" v-model="popover">
                                            <span>22</span>
                                            <div slot="reference" class="add-btn">44
                                            </div>
                                            <div slot="reference" class="add-btn">55
                                            </div>
                                    </el-popover> -->
                              ...
                              <!--   <div v-for="item in 10" :key="item">
                                    <el-popover placement="top" width="160" v-model="popover">
                                        <p>确定删除吗？</p>
                                        <div>
                                ...
                                <div class="itemLi" 
:class="{gray: (salse.flashsaleStatus==3 || salse.flashsaleStock<1), red:salse.flashsaleStatus==2, yellow:salse.flashsaleStatus==1}" 
