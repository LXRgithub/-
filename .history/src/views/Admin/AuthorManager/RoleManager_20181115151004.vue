        ...
        <el-header>
            <el-row>
                <el-col :sm="12" :md="12" :lg="12" :xl="12">
                     <el-tabs v-model="tagActName" @tab-click="handleClick($event)">
...
export default {
  ...
  methods:{
      handleClick(tab){//    transform: translateX(220px);
          console.log('tagclick',tab,$('.el-tabs__active-bar').css('transform'))
          $('.el-tabs__active-bar').css('transform','translateX(200px)')
      }
  }
}
</script>
