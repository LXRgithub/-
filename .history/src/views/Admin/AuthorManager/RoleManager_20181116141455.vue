                            ...
                            <div class="user-list">
                                <div v-for="(item, index) in customRoleData" :key="index" class="user-role"
                                    ...
                                    @click="clickRoleList(item.id)">
                                         <el-popover
                                            placement="right"
                                            trigger="hover" v-model="item.state">
                                                <div style="text-align: center; margin: 0">
                                                    <el-button size="mini" icon="el-icon-edit" @click="clickPopover(item.state)"></el-button>
                                                </div>
                                                <span slot="reference">{{item.state}}{{ item.name }}</span>
                                        </el-popover>
                                </div>
